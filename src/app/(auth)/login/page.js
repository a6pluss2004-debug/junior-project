    ...
    <div className="animate-fade-in-up">
      ...
      <div className="text-center mb-10">
        <div className="relative mx-auto w-24 h-24 mb-8">
          {/* Outer rotating ring */}
          <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-[#78e0dc] via-[#ff8d4c] to-[#3d348b] animate-spin-slow opacity-80"></div>
          {/* Middle ring */}
        ...
        <p className="text-lg text-white/80 font-medium">
          ...
          <Link
            href="/register"
            className="font-bold text-[#ff8d4c] hover:text-[#ffa366] transition-all duration-300 hover:underline underline-offset-4 inline-flex items-center gap-1.5 group relative"
          >
            ...
            <span className="absolute inset-0 bg-[#ff8d4c]/10 rounded-lg blur-xl scale-0 group-hover:scale-100 transition-transform duration-300"></span>
          </Link>
        </p>
      </div>
      ...
      <div className="relative group">
        ...
        <div className="relative bg-gradient-to-br from-white/[0.15] to-white/[0.05] backdrop-blur-2xl rounded-[26px] shadow-[0_8px_32px_rgba(0,0,0,0.4)] border border-white/20 p-10 sm:p-12 overflow-hidden">
          ...
          <form action={action} className="relative z-10 space-y-7">
            ...
            <div className="pt-4">
              <button
                type="submit"
                disabled={isPending}
                className="group/button relative w-full overflow-hidden rounded-2xl transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:scale-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#ff8d4c]"
              >
                {/* Gradient border */}
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-[#ff8d4c] via-[#ff6b35] to-[#ff8d4c] bg-[length:200%_100%] group-hover/button:animate-gradient-x"></div>
                
                {/* Inner button */}
                <div className="relative m-[2px] rounded-[14px] bg-gradient-to-r from-[#ff8d4c] to-[#ff6b35] px-8 py-5 transition-all duration-300 group-hover/button:shadow-[0_0_40px_rgba(255,141,76,0.4)]">
